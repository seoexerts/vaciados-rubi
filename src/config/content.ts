...
export const content = {
  ...
  benefits: [
    {
      icon: 'shield',
      title:       'Equipo propio en {{city}}',
      description: 'No subcontratamos. Nuestros operarios son empleados directos con formación y seguro. Trato directo y responsable siempre.',
    },
    {
      icon: 'clock',
      title:       'Presupuesto en menos de 24 h',
      description: 'Envíanos fotos por WhatsApp y te respondemos con precio cerrado sin visita previa. Sin esperas ni desplazamientos innecesarios.',
    },
    {
      icon: 'check',
      title:       'Precio cerrado, sin sorpresas',
      description: 'El presupuesto que aceptas es el precio final. No hay extras ocultos ni costes adicionales al terminar el trabajo.',
    },
    {
      icon: 'box',
      title:       'Gestión de residuos certificada',
      description: 'Llevamos todo a gestores autorizados. Podemos emitir certificado de gestión si lo necesitas para baja de actividad o herencia.',
    },
    {
      icon: 'heart',
      title:       'Donamos a entidades sociales',
      description: 'Los objetos en buen estado los donamos a asociaciones locales. Damos una segunda vida a todo lo que sea reutilizable.',
    },
    {
      icon: 'users',
      title:       'Discreción total en casos sensibles',
      description: 'Herencias, síndrome de Diógenes, desahucios o separaciones. Actuamos con máximo respeto y confidencialidad.',
    }
  ],
